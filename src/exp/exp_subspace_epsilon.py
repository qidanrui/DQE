...
from main_dqe import subspace_main as run_single_exp
...
if __name__ == '__main__':
    ...
    neighbor_k = 18
    for error_distance in [1,2,3,4,5]:
    ...
    with open('result/subspace_epsilon_jaccard_letter.dat', 'w') as f:
        f.write(output_content_jaccard)
    with open('result/subspace_epsilon_f1_letter.dat', 'w') as f:
        f.write(output_content_f1)
    with open('result/subspace_epsilon_error_count_letter.dat', 'w') as f:
        f.write(output_content_error_count)
    with open('result/subspace_epsilon_time_letter.dat', 'w') as f:
