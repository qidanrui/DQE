...
from main_dqe import avg_attr_main as run_single_exp
...
from main_dorc import avg_num_main as run_single_exp_dorc
...
if __name__ == '__main__':
    ...
    output_content_error_count = 'ErrorCount\tKNN\tDC\tDORC\tSUBSPACE\r\n'
    ...
    neighbor_k = 10
    for error_distance in [1, 1.5, 2, 2.5, 3]:
        ...
        output_content_error_count += str(error_distance) + '\t%f\t%f\t%f\t%f\r\n' % tuple(errorcount)
        #output_content_time += str(error_distance) + '\t%f\t%f\r\n' % tuple(time_used)
    ...
    with open('result/subspace_epsilon_error_count_magic.dat', 'w') as f:
        f.write(output_content_error_count)
    #with open('result/subspace_epsilon_time_magic.dat', 'w') as f:
